...
True, p = (89.11+80.31)/2=84.71 which is 1 margin of error from the upper and lower bound
...
The requirement for inference is n>30 and  36 just meets the requirement
...
(a) Perform a hypothesis test to evaluate if the data provide convincing evidence that the average IQ of mothers of gifted children is different than the average IQ for the population at large, which is 100. Use a significance level of 0.10.
