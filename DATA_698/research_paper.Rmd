...
Other features like time in hospital, num lab procedures, number diagnoses and num medications didn't play as large a role as what we would have expected; however the eda did propose that fact. When all features were used the reason for admission and discharge scored the highest in feature importance. 
