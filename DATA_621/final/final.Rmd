...
```{r}
drop_cols = c('adwordsClickInfo.isVideoAd', 'adwordsClickInfo.adNetworkType', 'adwordsClickInfo.gclId', 'adwordsClickInfo.slot', 'adwordsClickInfo.page', 'campaignCode', 'isTrueDirect')
...
```{r}
p1 <- session(df, deviceCategory, 6)
p2 <- revenue(df, deviceCategory, 6)
grid.arrange(p1, p2)
```
