...
def exercise03():
    ...
    while len(countdown) > 0:
        ...
        for i,v in enumerate(countdown):
            if v == num:
                countdown.pop(i)
    countdown = new_lst
...
def exercise04(more_temperatures, iot_sensor_points, a, b, c, d, e):
    ...
    # ------ Place code below here \/ \/ \/ ------
    import copy
    temperatures += list(more_temperatures)
    temperatures += iot_sensor_points.values()
    temperatures += [a,b,c,d,e]
