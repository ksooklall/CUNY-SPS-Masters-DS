...
#### Read in the data 
Read csv and transform to have shape `nx4`
...
```{r}
df<-read.csv('/home/kenan/Documents/learning/masters/CUNY-SPS-Masters-DS/DATA_607/homework/homework5/flightdata.csv', sep=',')
